...
deeMainWindow::deeMainWindow( int vtkNotUsed(argc), char *argv[]){
	...
	reader->SetDirectoryName("C:/DB/ROUAN1");
	reader->Update();
	int imageDims[3];
	...
	void deeMainWindow::slotExit()
	{
	qApp->exit();
	}

	void deeMainWindow::resliceMode(int mode)
	{
	...
	void deeMainWindow::thickMode(int mode)
	{
	for (int i = 0; i < 3; i++)
	{
	...
	void deeMainWindow::SetBlendMode(int m)
	{
	for (int i = 0; i < 3; i++)
	{
	...
	void deeMainWindow::SetBlendModeToMaxIP()
	{
	this->SetBlendMode(VTK_IMAGE_SLAB_MAX);
	}

	void deeMainWindow::SetBlendModeToMinIP()
	{
	this->SetBlendMode(VTK_IMAGE_SLAB_MIN);
	}

	void deeMainWindow::SetBlendModeToMeanIP()
	{
	this->SetBlendMode(VTK_IMAGE_SLAB_MEAN);
	}

	void deeMainWindow::ResetViews()
	{
	...
	void deeMainWindow::AddDistanceMeasurementToView1()
	{
	this->AddDistanceMeasurementToView(1);
	}

	void deeMainWindow::AddDistanceMeasurementToView(int i)
	{
